...
/***/ "./src/app/theMovieDB/movies.service.ts":
/*!**********************************************!*\
  !*** ./src/app/theMovieDB/movies.service.ts ***!
  \**********************************************/
...
var MoviesService = /** @class */ (function () {
    function MoviesService(http) {
        this.http = http;
        this.chave = "23da55870598661f71fb1f6d7b054c43";
        this.caminhoPadrao = "https://api.themoviedb.org/3";
    }
    MoviesService.prototype.getPopularMovies = function (page, language) {
        if (page === void 0) { page = 1; }
        if (language === void 0) { language = "pt-BR"; }
        var filmes = this.caminhoPadrao + "/movie/popular?api_key=" + this.chave + "&language=" + language + "&page=" + page;
        return this.http.get(filmes);
    };
    MoviesService.prototype.getNowPlaying = function (page, language) {
        if (page === void 0) { page = 1; }
        if (language === void 0) { language = "pt-BR"; }
        var filmes = this.caminhoPadrao + "/movie/now_playing?api_key=" + this.chave + "&language=" + language + "&page=" + page + "&region=BR";
        return this.http.get(filmes);
    };
