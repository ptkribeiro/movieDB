...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar) {
        ...
        this.appMenu = [
            { title: 'Home', url: 'tabs/tabs/tab1', icon: 'list' },
            { title: 'Popular', url: 'tabs/tabs/tab2', icon: 'add' },
            { title: 'Em Exibição', url: 'tabs/tabs/tab3', icon: 'trash' },
            { title: 'Sair', url: '' }
        ];
        this.initializeApp();
    }
...
var environment = {
    production: false,
    firebase: {
        apiKey: "AIzaSyB-WednZwWj5vIY2oX3Tx94mRU77KC0u9w",
        authDomain: "teste-d86d6.firebaseapp.com",
        databaseURL: "https://teste-d86d6.firebaseio.com",
        projectId: "teste-d86d6",
        storageBucket: "teste-d86d6.appspot.com",
        messagingSenderId: "1045361143676",
        appId: "1:1045361143676:web:cd852af1fec9f2e96d3ef9"
    }
};
/*
...
module.exports = __webpack_require__(/*! D:\Arquivos\Projetos\Unisuam\myApp\src\main.ts */"./src/main.ts");
